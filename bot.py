...
RESPONSES = {
    'help': (
        ...
        "→ Напишите координатору: [@kondrashkin\\_pro](https://t\\.me/kondrashkin_pro?text=Здравствуйте!%20Хотел(а)%20бы%20подобрать%20специалиста%20в%20рамках%20бесплатной%20психологической%20помощи)\n\n"
        "*Также доступна поддержка от специально обученных волонтёров:*\n"
        "→ Написать: [@pgprobono](https://t\\.me/pgprobono?text=Здравствуйте,%20мне%20нужна%20психологическая%20помощь)\n\n"
    ...
    'support_group': (
        ...
        "Чтобы узнать о ближайших встречах, напишите в [@prostogovorite](https://t\\.me/prostogovorite?text=Здравствуйте,%20хочу%20попасть%20в%20группу%20поддержки!)\n\n"
    ...
    'hotline': (
        ...
        "• Без осуждения\n"
        "• В формате чата\n\n"
        "→ Написать в телефон доверия: [@pgprobono](https://t\\.me/pgprobono?text=Здравствуйте,%20мне%20нужна%20психологическая%20помощь)\n\n"
        "👥 Чат поддержки: @psysrb\n"

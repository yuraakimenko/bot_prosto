...
RESPONSES = {
    'help': (
        ...
        "→ Напишите координатору: [@kondrashkin\\_pro](https://t\\.me/kondrashkin_pro?text=Здравствуйте!+Хотел(а)+бы+подобрать+специалиста+в+рамках+бесплатной+психологической+помощи)\n\n"
        "*Также доступна поддержка от специально обученных волонтёров:*\n"
        "→ Написать: [@pgprobono](https://t\\.me/pgprobono?text=Здравствуйте,+мне+нужна+психологическая+помощь)\n\n"
    ...
    'support_group': (
        ...
        "Чтобы узнать о ближайших встречах, напишите в [@prostogovorite](https://t\\.me/prostogovorite?text=Здравствуйте,+хочу+попасть+в+группу+поддержки!)\n\n"
    ...
    'hotline': (
        ...
        "• Без осуждения\n"
        "• В формате чата\n\n"
        "→ Написать в телефон доверия: [@pgprobono](https://t\\.me/pgprobono?text=Здравствуйте,+мне+нужна+психологическая+помощь)\n\n"
        "👥 Чат поддержки: @psysrb\n"

...
RESPONSES = {
    'help': (
        ...
        "→ Напишите координатору: [@kondrashkin\\_pro](https://t\\.me/kondrashkin_pro?text=Здравствуйте%21%20Хотел%28а%29%20бы%20подобрать%20специалиста%20в%20рамках%20бесплатной%20психологической%20помощи\\.)\n\n"
        "*Также доступна поддержка от специально обученных волонтёров:*\n"
        "→ Написать: [@pgprobono](https://t\\.me/pgprobono?text=Здравствуйте%2C%20мне%20нужна%20психологическая%20помощь\\.)\n\n"
